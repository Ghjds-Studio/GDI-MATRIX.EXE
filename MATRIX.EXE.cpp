...
DWORD WINAPI MATRIX2(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
...
DWORD WINAPI MATRIX3(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
	while (GetTickCount() - startTime < 30000) {
...
DWORD WINAPI MATRIX4(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
	while (GetTickCount() - startTime < 30000) {
...
DWORD WINAPI MATRIX5(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
	while (GetTickCount() - startTime < 30000) {
...
DWORD WINAPI MATRIX6(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
	while (GetTickCount() - startTime < 30000) {
...
DWORD WINAPI MATRIX7(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
...
DWORD WINAPI MATRIX8(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
...
DWORD WINAPI MATRIX9(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
...
DWORD WINAPI MATRIX10(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
...
DWORD WINAPI MATRIX11(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
	int cx = w / 2, cy = h / 2;
...
DWORD WINAPI MATRIX12(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
	int signX = 1;
	...
	while (GetTickCount() - startTime < 30000) {
		...
		HPEN pen = CreatePen(PS_SOLID, 3, RGB(0, green, 0));
		HPEN oldPen = (HPEN)SelectObject(hdc, pen);
		HBRUSH brush = CreateSolidBrush(RGB(0, green, 0));
		HBRUSH oldBrush = (HBRUSH)SelectObject(hdc, brush);
...
DWORD WINAPI MATRIX13(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
	int cx = w / 2, cy = h / 2;
...
DWORD WINAPI MATRIX14(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
...
DWORD WINAPI MATRIX15(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
...
DWORD WINAPI MATRIX16(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
...
DWORD WINAPI MATRIX17(LPVOID lpvd) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	DWORD startTime = GetTickCount();
	const int COLS = 60;
...
DWORD WINAPI MATRIX18(LPVOID lpvd) {
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	HDC hdc = GetDC(0);
	FLOAT angle = 0.01;
	for (int i = 0;; i++) {
...
DWORD WINAPI MATRIX19(LPVOID lpvd) {
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	HDC hdc = GetDC(0);
	for (int i = 0;; i++) {
...
DWORD WINAPI MATRIX20(LPVOID lpParam) {
...
DWORD WINAPI MATRIX21(LPVOID lpParam)
{
	HDC hdc = GetDC(NULL);
...
DWORD WINAPI MATRIX22(LPVOID lpParam) {
...
DWORD WINAPI MATRIX23(LPVOID lpParam) {
...
DWORD WINAPI MATRIX24(LPVOID lpParam) {
	HDC hdcScreen = GetDC(NULL);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
...
DWORD WINAPI MATRIX25(LPVOID lpParam) {
	for (;;) {
		int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
		POINT p[3];
		HDC hdc = GetDC(0);
...
DWORD WINAPI MATRIX26(LPVOID lparam) {
	int a = 2;
	for (;;) {
		HDC hdc = GetDC(0);
		int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
...
DWORD WINAPI MATRIX27(LPVOID lparam) {
...
DWORD WINAPI MATRIX28(LPVOID lpParam) {
	HDC hdc = GetDC(0);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	BITMAPINFO bmi = { 0 };
	bmi.bmiHeader.biSize = sizeof(BITMAPINFO);
...
DWORD WINAPI MATRIX29(LPVOID lparam) {
	HWND hwnd = GetDesktopWindow();
	HDC hdc = GetWindowDC(hwnd);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	while (1) {
...
DWORD WINAPI MATRIX30(LPVOID lparam) {
	HWND hwnd = GetDesktopWindow();
	HDC hdc = GetWindowDC(hwnd);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	while (1) {
...
DWORD WINAPI MATRIX31(LPVOID lparam) {
	HWND hwnd = GetDesktopWindow();
	HDC hdc = GetWindowDC(hwnd);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	while (1) {
...
DWORD WINAPI MATRIX32(LPVOID lpParam) {
	RECT rect;
...
DWORD WINAPI MATRIX33(LPVOID lpvd) {
	HDC hdcScreen = GetDC(0), hdcMem = CreateCompatibleDC(hdcScreen);
	INT w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	BITMAPINFO bmi = { 0 };
	RGBQ rgbScreen = { 0 };
...
DWORD WINAPI MATRIX34(LPVOID lpvd) {
	HDC hdcScreen = GetDC(0), hdcMem = CreateCompatibleDC(hdcScreen);
	INT w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	BITMAPINFO bmi = { 0 };
	RGBQ rgbScreen = { 0 };
...
DWORD WINAPI MATRIX35(LPVOID lpvd) {
	HDC hdcScreen = GetDC(0), hdcMem = CreateCompatibleDC(hdcScreen);
	INT w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	BITMAPINFO bmi = { 0 };
	RGBQ rgbScreen = { 0 };
...
DWORD WINAPI MATRIX36(LPVOID lpParam) {
	FLOAT angle = 0;
	for (int t = 0;; t++) {
...
DWORD WINAPI MATRIX37(LPVOID lpParam) {
	HDC hdc = GetDC(NULL);
	HDC hdcCopy = CreateCompatibleDC(hdc);
...
DWORD WINAPI MATRIX38(LPVOID lpParam) {
	for (;;)
	{
		HDC hdc = GetDC(NULL);
...
DWORD WINAPI MATRIX39(LPVOID lpParam) {
	for (int t = 0;; t++) {
		HDC hdc = GetDC(NULL);
		int w = GetSystemMetrics(SM_CXSCREEN), h = GetSystemMetrics(SM_CYSCREEN);
		HDC hcdc = CreateCompatibleDC(hdc);
...
DWORD WINAPI MATRIX40(LPVOID l) {
...
DWORD WINAPI MATRIX41(LPVOID l) {
	int screen_w = GetSystemMetrics(SM_CXSCREEN);
	int screen_h = GetSystemMetrics(SM_CYSCREEN);
	int cell_w = screen_w / 2;
	int cell_h = screen_h / 2;
...
DWORD WINAPI MATRIX42(LPVOID l) {
	int screen_w = GetSystemMetrics(SM_CXSCREEN);
	int screen_h = GetSystemMetrics(SM_CYSCREEN);
	int cell_w = screen_w / 2;
	int cell_h = screen_h / 2;
...
DWORD WINAPI MATRIX43(LPVOID lpvd) {
	HDC hdcScreen = GetDC(NULL);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	HDC hdcMem = CreateCompatibleDC(hdcScreen);
...
DWORD WINAPI MATRIX44(LPVOID lpvd) {
	HDC hdcScreen = GetDC(NULL);
	int w = GetSystemMetrics(0), h = GetSystemMetrics(1);
	HDC hdcMem = CreateCompatibleDC(hdcScreen);
	HBITMAP hbmScreen = CreateCompatibleBitmap(hdcScreen, w, h);
...
DWORD WINAPI MATRIX45(LPVOID lpParam) {
...
DWORD WINAPI MATRIX46(LPVOID lpParam) {
	for (int t = 0;; t++) {
		HDC hdcScreen = GetDC(NULL);
		int w = GetSystemMetrics(SM_CXSCREEN), h = GetSystemMetrics(SM_CYSCREEN);
...
DWORD WINAPI MATRIX47(LPVOID lparam) {
...
DWORD WINAPI MATRIX48(LPVOID lparam) {
	int w = GetSystemMetrics(SM_CXSCREEN), h = GetSystemMetrics(SM_CYSCREEN);
	...
	int numChars = sizeof(matrixChars) / sizeof(matrixChars[0]);
	while (true)
	{
		hdc = GetDC(0);
		...
		for (int i = 0; i < 300; i++) {
			int fontx = rand() % w;
			int fonty = rand() % h;
			int fontSize = 12 + rand() % 36;
			int brightness = 50 + rand() % 206;
			SetBkColor(hcdc, RGB(0, 0, 0));
			SetTextColor(hcdc, RGB(0, brightness, 0));
			HFONT font = CreateFont(fontSize, fontSize / 2, 0, 0, FW_NORMAL, false, false, false,
				ANSI_CHARSET, OUT_CHARACTER_PRECIS, CLIP_CHARACTER_PRECIS,
				DEFAULT_QUALITY, FF_DONTCARE, L"Courier New");
			SelectObject(hcdc, font);
			const char* charToDraw = matrixChars[rand() % numChars];
			TextOutA(hcdc, fontx, fonty, charToDraw, strlen(charToDraw));
			DeleteObject(font);
		}
		POINT point[3];
		...
		PlgBlt(hdc, point, hcdc, 0, 0, w, h, 0, 0, 0);
		ReleaseDC(NULL, hdc);
		Sleep(20);
	}
	DeleteDC(hcdc);
...
DWORD WINAPI MATRIX49(LPVOID lpParam) {
	const char* messages[] = {
...
int main() {
	...
	HANDLE hMATRIX1 = CreateThread(0, 0, MATRIX1, 0, 0, 0);
	sound1();
	RunNewStage(MATRIX2, 30000);
	sound2();
	RunNewStage(MATRIX3, 30000);
	sound3();
	RunNewStage(MATRIX4, 30000);
	sound4();
	RunNewStage(MATRIX5, 30000);
	sound5();
	RunNewStage(MATRIX6, 30000);
	sound6();
	RunNewStage(MATRIX7, 30000);
	sound1();
	RunNewStage(MATRIX8, 30000);
	sound2();
	RunNewStage(MATRIX9, 30000);
	sound3();
	RunNewStage(MATRIX10, 30000);
	sound4();
	RunNewStage(MATRIX11, 30000);
	sound5();
	RunNewStage(MATRIX12, 30000);
	sound6();
	RunNewStage(MATRIX13, 30000);
	sound7();
	RunNewStage(MATRIX14, 30000);
	sound8();
	RunNewStage(MATRIX15, 30000);
	sound1();
	RunNewStage(MATRIX16, 30000);
	sound2();
	RunNewStage(MATRIX17, 30000);
	sound3();
	RunThreadDouble(MATRIX18, MATRIX19, 30000);
	sound4();
	RunNewStage(MATRIX20, 30000);
	sound5();
	RunThreadDouble(MATRIX21, MATRIX22, 30000);
	sound6();
	RunThreadDouble(MATRIX23, MATRIX21, 30000);
	sound7();
	RunNewStage(MATRIX24, 30000);
	sound8();
	RunNewStage(MATRIX25, 30000);
	sound9();
	RunThreadDouble(MATRIX26, MATRIX27, 30000);
	sound10();
	RunThreadDouble(MATRIX28, MATRIX29, 30000);
	sound1();
	RunThreadThree(MATRIX30, MATRIX31, MATRIX32, 30000);
	sound2();
	RunNewStage(MATRIX33, 30000);
	sound3();
	RunNewStage(MATRIX34, 30000);
	sound4();
	RunNewStage(MATRIX35, 30000);
	sound5();
	RunNewStage(MATRIX36, 30000);
	sound6();
	RunNewStage(MATRIX37, 30000);
	sound7();
	RunNewStage(MATRIX38, 30000);
	sound8();
	RunNewStage(MATRIX39, 30000);
	sound9();
	RunNewStage(MATRIX40, 30000);
	sound10();
	RunNewStage(MATRIX41, 30000);
	sound11();
	RunNewStage(MATRIX42, 30000);
	sound12();
	RunNewStage(MATRIX43, 30000);
	sound5();
	RunNewStage(MATRIX44, 30000);
	HANDLE hM45 = CreateThread(0, 0, MATRIX45, 0, 0, 0);
	sound6();
	TerminateThread(hM45, 0);
	CloseHandle(hM45);
	RedrawWindow(NULL, NULL, NULL, RDW_ERASE | RDW_INVALIDATE | RDW_ALLCHILDREN);
	Sleep(50);
	HANDLE hM46 = CreateThread(0, 0, MATRIX46, 0, 0, 0);
	sound7();
	TerminateThread(hM46, 0);
	CloseHandle(hM46);
	RedrawWindow(NULL, NULL, NULL, RDW_ERASE | RDW_INVALIDATE | RDW_ALLCHILDREN);
	Sleep(50);
	sound8();
	RunNewStage(MATRIX47, 30000);
	sound9();
	RunNewStage(MATRIX48, 30000);
	sound10();
	RunNewStage(MATRIX49, 30000);
	TerminateThread(hMATRIX1, 0);
	CloseHandle(hMATRIX1);
	ExitProcess(0);
}
